...
decomposed = decompose(ts_inflow_data[, "HP15"], "additive")
plot(decomposed)

no_season = decomposed$x - decomposed$seasonal
...
acf2 = Acf(s, lag.max = 40, plot = TRUE)

#Exercise 4: Compare PACFs for full series and deseason series
par(mfrow=c(1,2))
pacf1 = Pacf(ts_inflow_data[,"HP15"], lag.max = 40, plot = TRUE)
pacf2 = Pacf(s, lag.max = 40, plot = TRUE)
